    ...
    <div id="default-carousel" class="relative w-full" data-carousel="slide">
      ...
      <div class="relative h-fit overflow-hidden rounded-lg md:h-[450px]">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="https://res.cloudinary.com/dat9zyjdy/image/upload/v1699931681/hoola/home-page/solution-2.png"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
          <img src="https://res.cloudinary.com/dat9zyjdy/image/upload/v1699417503/hoola/home-page/hero-banner.png"
            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
      ...
      <button type="button"
        ...
        <span
          ...
          <svg class="w-4 h-4 text-secondary dark:text-gray-800 rtl:rotate-180 group-hover:text-white" aria-hidden="true"
