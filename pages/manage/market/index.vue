    ...
    <section class="w-screen h-full">
      <section class="w-auto mx-8 flex">
        <section class="max-w-[234px] min-w-[200px] h-auto mr-8 mb-8 mt-6">
          <button id="button-sidebar" type="button" class="text-4xl font-bold pb-6 items-center flex -translate-x-[10%]">
            <fa class="icon text-base self-center" icon="angles-left" />
            <span class="pl-2"> Hàng hóa </span>
          </button>
          <section>
            <article id="accordion-collapse-heading-classification" data-accordion="collapse"
              class="relative bg-primary mb-4 p-3 shadow-xl rounded-md h-full transition-all duration-200">
              <button type="button" class="w-full p-1 bg-white flex justify-between"
                data-accordion-target="#accordion-collapse-body-classification" aria-expanded="false"
                aria-controls="accordion-collapse-body-classification">
                <span> Loại hàng </span>
                <fa data-accordion-icon icon="caret-down" />
              </button>
              <ul id="accordion-collapse-body-classification" class="hidden pt-4"
                aria-labelledby="accordion-collapse-heading-classification">
                <div class="pb-2">
                  <input id="hanghoa" v-model="checkTypeProduct"
                    class="cursor-pointer focus:ring-0 text-secondary ring-0 border-[1px] border-solid border-black rounded"
                    type="checkbox" value="hanghoa" />

                  <label for="hanghoa" class="pl-1 text-xs cursor-pointer">Hàng hóa</label>
                </div>
                <div class="pb-2">
                  <input id="dichvu" v-model="checkTypeProduct"
                    class="cursor-pointer focus:ring-0 text-secondary ring-0 border-[1px] border-solid border-black rounded"
                    type="checkbox" value="dichvu" />

                  <label for="dichvu" class="pl-1 text-xs cursor-pointer">Dịch vụ</label>
                </div>
              </ul>
            </article>
            <article id="accordion-collapse-heading-suplier" data-accordion="collapse"
              class="relative bg-primary mb-4 p-3 shadow-xl rounded-md">
              <button type="button" class="w-full p-1 bg-white flex justify-between"
                data-accordion-target="#accordion-collapse-body-suplier" aria-expanded="false"
                aria-controls="accordion-collapse-body-suplier">
                <span>Nhà cung cấp</span>
                <fa data-accordion-icon icon="caret-down" />
              </button>
              <div id="accordion-collapse-body-suplier" aria-labelledby="accordion-collapse-heading-suplier"
                class="hidden pt-4 transition-transform duration-1000">
                <div id="accordion-collapse-heading-stock-child" class="relative max-w-[175px]" data-accordion="collapse">
                  <input v-model="checkSupplier" type="text" placeholder="Nhà cung cấp"
                  ...
                  <button class="absolute self-center bg-transparent right-1 top-[-8px] p-2"
                    data-accordion-target="#accordion-collapse-body-stock-child" aria-expanded="false"
                    aria-controls="accordion-collapse-body-stock-child">
                    <fa data-accordion-icon icon="caret-down" />
                  </button>
                </div>
                <div id="accordion-collapse-body-stock-child" aria-labelledby="accordion-collapse-heading-stock-child"
                  class="hidden pt-4 transition-transform duration-1000">
            ...
            <article id="accordion-collapse-heading-suplier" data-accordion="collapse"
              ...
              <button type="button" class="w-full bg-white p-1 flex justify-between"
                data-accordion-target="#accordion-collapse-body-stock" aria-expanded="false"
                aria-controls="accordion-collapse-body-stock">
                <span>Tình trạnh trong kho</span>
                <fa data-accordion-icon icon="caret-down" />
              </button>
              <ul id="accordion-collapse-body-stock" aria-labelledby="accordion-collapse-heading-stock"
                class="hidden pt-4 transition-transform duration-1000">
                <div class="pb-2">
                  <input id="overall-inventory" v-model="checkStockProduct"
                    class="cursor-pointer focus:ring-0 text-secondary ring-0 border-[1px] border-solid border-black rounded-full"
                    type="radio" name="inventory-status" :value="{ $gte: 0 }" @change="handleFindProducts" />
                  <label for="overall-inventory" class="pl-1 text-xs cursor-pointer">Tất cả</label>
                </div>
                <div class="pb-2">
                  <input id="outstock-inventory" v-model="checkStockProduct"
                    class="cursor-pointer focus:ring-0 text-secondary ring-0 border-[1px] border-solid border-black rounded-full"
                    type="radio" name="inventory-status" :value="{ $eq: 0 }" @change="handleFindProducts" />
                  <label for="outstock-inventory" class="pl-1 text-xs cursor-pointer">Hết hàng
                  </label>
                </div>
                <div class="pb-2">
                  <input id="instock-inventory" v-model="checkStockProduct"
                    class="cursor-pointer focus:ring-0 text-secondary ring-0 border-[1px] border-solid border-black rounded-full"
                    type="radio" name="inventory-status" :value="{ $gt: 0 }" @change="handleFindProducts" />

                  <label for="instock-inventory" class="pl-1 text-xs cursor-pointer">Còn hàng</label>
                </div>
              </ul>
            </article>
            <aside class="pr-0 pt-3 pl-3 items-center flex justify-end">
              <div class="cursor-pointer flex items-baseline gap-1" data-dropdown-toggle="dropdown-pageSize"
                data-dropdown-trigger="click" data-dropdown-placement="bottom-end">
              ...
              <div id="dropdown-pageSize"
                ...
                <ul class="py-2">
                  <li class="hover:bg-secondaryDark">
                    <input id="pageSize-10" v-model="pagination.pageSize" class="hidden" type="radio" name="pageSize"
                      :value="10" @change="handleFindProducts" />
                    <label for="pageSize-10" class="cursor-pointer px-3 py-1">10</label>
                  </li>
                  <li class="hover:bg-secondaryDark">
                    <input id="pageSize-20" v-model="pagination.pageSize" class="hidden" type="radio" name="pageSize"
                      :value="20" @change="handleFindProducts()" />
                    <label for="pageSize-20" class="cursor-pointer px-3 py-1">20</label>
                  </li>
                  <li class="hover:bg-secondaryDark">
                    <input id="pageSize-50" v-model="pagination.pageSize" class="hidden" type="radio" name="pageSize"
                      :value="50" @change="handleFindProducts()" />
                    <label for="pageSize-50" class="cursor-pointer px-3 py-1">50</label>
                  </li>
                </ul>
              </div>
            </aside>
          ...
          <div class="mt-6 min-h-[inherit] w-full relative">
            <article class="flex mt-0 items-baseline min-h-[54px]">
              <div class="grow shrink items-center flex min-h-[40px]">
                <div
                  ...
                  <input v-model="inputFilter" type="text" placeholder="Nhập mặt hàng"
              ...
              <aside class="flex self-start gap-4 min-h-[40px]">
                <div data-dropdown-toggle="dropdown-add" data-dropdown-trigger="click" data-dropdown-delay="500"
                ...
                <div data-dropdown-toggle="dropdown-more" data-dropdown-trigger="click" data-dropdown-delay="500"
                ...
                <div id="dropdown-add"
                  ...
                  <ul class="py-2">
                    ...
                    <li class="cursor-pointer flex items-center gap-1 px-3 py-1 text-primary hover:bg-secondaryDark">
                ...
                <div id="dropdown-more"
                  class="hidden shadow-xl divide-y divide-gray-100 bg-secondary text-sm z-10 rounded-lg">
                  <ul class="py-2">
                    <li v-for="(dataCol, index) in dataTable" :key="index" class="px-3 py-1 text-primary">
                      <input :id="`checkbox-show-${dataCol.label}`" v-model="dataCol.checked" type="checkbox"
                        :checked="dataCol.checked" :disabled="dataCol?.disable"
                      ...
                      <label :for="`checkbox-show-${dataCol.label}`" class="pl-1 text-xs cursor-pointer">{{ dataCol.label
                      }}</label>
                    </li>
                  </ul>
                </div>
            ...
            <article class="w-full left">
              <table-viewer-grid :loading="loading">
                <template #header>
                  <thead>
                    <tr class="box-content">
                      <th class="p-3 min-w-[140px] max-w-[140px] w-[140px] break-normal">
                        <span class="box-content">Mã Sản Phẩm</span>
                      </th>
                      <th class="p-3 min-w-[200px]">
                        <span class="box-content">Tên Mặt Hàng</span>
                      </th>
                      <th v-if="dataTable[1].checked" class="p-3 min-w-[112px] max-w-[112px] w-[112px] text-end">
                        <span class="box-content">Ngày Cập Nhật</span>
                      </th>
                      <th v-if="dataTable[2].checked" class="p-3 min-w-[112px] max-w-[112px] w-[112px] text-end">
                        <span class="box-content">Tồn Kho</span>
                      </th>
                      <th v-if="dataTable[3].checked" class="p-3 min-w-[112px] max-w-[112px] w-[112px] text-end">
                        <span class="box-content">Thương Hiệu</span>
                      </th>
                      <th class="p-3 min-w-[112px] max-w-[112px] w-[112px] text-end">
                ...
                <template #body>
                  <table class="table-fixed w-auto min-w-full max-w-none">
                    <thead class="">
                      <tr class="box-content bg-gray-200 border-b-[1px] border-solid border-gray-500">
                        <th class="p-3 min-w-[140px] max-w-[140px] w-[140px] break-normal">
              ...
              <div class="flex py-5 items-baseline">
                <pagination-page-control :pagination="pagination" @set-page="setPage" @find="handleFindProducts()" />
        ...
        <div>
          <form class="px-6" @submit.prevent="handleAddProduct">
            <div class="grid gap-4 m-4 sm:grid-cols-2">
              <div class="relative">
                <input id="product-name" v-model="productAtrributes.name" required autocomplete="off" type="text"
                  class="form-input peer" />
                <label for="productAtrributes-name" class="form-label">Tên sản phẩm
                </label>
              </div>
              <div class="relative">
                <input id="price" v-model="productAtrributes.price" required autocomplete="off" type="number"
                  class="form-input peer" />
                <label for="price" class="form-label">Giá </label>
              </div>
              <div class="relative">
                <input id="inventory" v-model="productAtrributes.inventory" required autocomplete="off" type="number"
                  class="form-input peer" />
                <label for="inventory" class="form-label">Số lượng </label>
              </div>
              <div class="relative">
                <input id="brand" v-model="productAtrributes.brand" required autocomplete="off" type="text"
                  class="form-input peer" />
              ...
              <div class="sm:col-span-2">
                ...
                <textarea id="description" rows="4"
                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 max-h-40"></textarea>
              </div>
            </div>
