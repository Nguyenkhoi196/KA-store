<template>
  <div>
    <div class="flex flex-col justify-between gap-10 bg-slate-100 mt-1">
      <!-- header -->
      <div class="flex">
        <div class="p-2 mx-auto">
          ...
          <div class="font-semibold font-mono text-yellow mt-3 mx-auto border-2 p-2 bg-white rounded-md">
            <div class="flex flex-row items-center text-yellow-600 gap-5 text-base">
              <div class="flex flex-row gap-1 text-center">
                <span class="col-span-1">
                  <fa :icon="['fas', 'shop']" />
                </span>
                <div class="col-span-2">
                  <p v-if="user" class="font-mono text-blue-600">{{ user.providerData[0].uid }}</p>
                </div>
              </div>
      ...
      <div class="mx-2">
        <!-- option -->
        <div class="grid grid-cols-2 grid-flow-row justify-between gap-3 content-center mx-2 ">
        ...
        <div class="flex flex-col content-center mx-2 rounded-md text-base">
          ...
          <nuxt-link to="">
            <div class="flex flex-row gap-2 px-4 py-2 border-t border-gray-200">
              <span>
                <fa :icon="['fas', 'phone']" />
              </span>
              Gọi <a class="text-blue-500">0915136016</a>
            </div>
          </nuxt-link>
          <nuxt-link to="">
            <div class="flex flex-row gap-2 px-4 py-2 border-t border-gray-200">
          ...
          <button @click="logOut">
            <div class="flex flex-row gap-2 px-4 py-2 text-red-500 border-t border-gray-200">
              <span>
                <fa :icon="['fas', 'right-to-bracket']" />
