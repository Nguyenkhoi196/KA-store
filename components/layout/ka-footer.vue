<template>
  <div>
    <footer class="bg-white dark:bg-gray-900 border-t-[0.5px] border-tertiary">
      <div class="container  p-4 pt-6 lg:py-10">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <div class="flex flex-col gap-1">
              ...
              <h5 class="text-md font-base mb-2">xuongcantonkhoianh@gmail.com</h5>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                  <a href="https://flowbite.com/" class="hover:underline">Sản phẩm</a>
                </li>
                <li>
                  <a href="https://tailwindcss.com/" class="hover:underline">Phân phối</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                <li class="mb-4">
                  <a href="https://github.com/themesberg/flowbite" class="hover:underline">Bảo mật thông tin
                  </a>
                </li>
                <li>
                  <a href="https://discord.gg/4eeurUVvTy" class="hover:underline">Chính sách giao hàng</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023
            <a href="https://flowbite.com/" class="hover:underline">Development by KhoiNguyen</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.facebook.com/profile.php?id=100089310123124"
